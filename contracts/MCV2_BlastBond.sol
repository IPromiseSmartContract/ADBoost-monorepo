...
contract MCV2_BlastBond is MCV2_Bond {
    ...
    IERC20Rebasing public constant USDB =
        IERC20Rebasing(0x4300000000000000000000000000000000000003); // Mainnet USDB
    IERC20Rebasing public constant WETH =
        IERC20Rebasing(0x4300000000000000000000000000000000000004); // Mainnet WETH
